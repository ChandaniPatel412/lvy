...
<div class="rev_slider_wrapper fullwidthbanner-container IntroSlider" style="margin: 0 auto; background-color: rgba(255, 255, 255, 0); padding: 0; color: #fff; margin-top: 0; margin-bottom: 0;">
  <div id="rev-slider5" class="rev_slider fullwidthabanner" style="display: none;">
    ...
    <ul>
      ...
      <!-- Slide -->
	  <li data-transition="fade" data-slotamount="1" data-easein="Power4.easeInOut" data-easeout="Power4.easeInOut" data-masterspeed="1000" data-rotate="0" data-saveperformance="off" data-title="Landing Page Slide" data-delay="3200">
            <!-- Main Image -->
            	<div class="Pattern"></div>
                <img src="images/videoImageZZZ.jpg" alt="Ivy Image" data-bgposition="center center"  data-duration="1" data-ease="Linear.easeNone" data-scalestart="100" data-scaleend="109" data-rotatestart="0" data-rotateend="0" data-offsetstart="0 0" data-offsetend="0 500" data-bgparallax="10" class="rev-slidebg" data-no-retina>
                <div class="tp-caption tp-resizeme color-white textBG"
                    data-x="['center','center','center','center']" data-hoffset="['0,'0','0','0']"
                    data-y="['middle','middle','middle','middle']" data-voffset="['40','40','40','10']"
                    data-fontsize="['31','31','31','21']"
                    data-lineheight="['32','32','32','22']"
                    data-width="none"
                    data-height="none"
                    data-whitespace="nowrap"
                    data-transform_idle="o:1;"
                    data-transform_in="y:0px;opacity:0;s:1500;e:Power3.easeInOut;"
                    data-start="500"
                    data-splitin="none"
                    data-splitout="none"
                    ...
                    <span style="font-family: 'HelveticaNeueLTStd-Bd';">coming soon</span> to downtown toronto
                </div>
            </li>
            <!-- End Slide -->
            
            <!-- Slide -->
	  <li data-transition="fade" data-slotamount="default" data-easein="Power4.easeInOut" data-easeout="Power4.easeInOut" data-masterspeed="1000" data-rotate="0" data-saveperformance="off" data-delay="18000" data-title="First Priority">
            <!-- Main Image -->
            <img src="images/videoImageZZZ.jpg" alt="Ivy Image" data-bgposition="center center"  data-duration="1" data-ease="Linear.easeNone" data-scalestart="100" data-scaleend="109" data-rotatestart="0" data-rotateend="0" data-offsetstart="0 0" data-offsetend="0 500" data-bgparallax="10" class="rev-slidebg" data-no-retina>
        <!-- Layers -->
            <div class="Pattern">
            ...
            <div class="rs-background-video-layer"
                ...
                data-videomp4="../video/Sequence 01_7.mp4"
        	...
        	<div class="tp-caption tp-resizeme color-white textBG"
                ...
                data-transform_idle="o:1;"
                data-transform_in="y:0px;opacity:0;s:1500;e:Power3.easeInOut;"
                data-transform_out="y:0px;opacity:0;s:1000;s:1000;"
                data-start="3000"
                data-end="5000"
                data-splitin="none"
                data-splitout="none"
                ...
                data-responsive_offset="on"
                style="z-index: 6; white-space: nowrap; letter-spacing:1px;">
                <span style="font-family: 'HelveticaNeueLTStd-Bd';">organic.</span> natural. beautiful.
            </div>
        	...
        	<div class="tp-caption tp-resizeme color-white textBG"
                ...
                data-responsive_offset="on"
                style="z-index: 6; white-space: nowrap; letter-spacing:1px;">
                ivy is a point tower in<span style="font-family: 'HelveticaNeueLTStd-Bd';">downtown toronto's garden district</span>
            </div>
        	...
        	<div class="tp-caption tp-resizeme color-white textBG"
                ...
                data-responsive_offset="on"
                style="z-index: 6; white-space: nowrap; letter-spacing:1px;">
                <span style="font-family: 'HelveticaNeueLTStd-Bd';">4 minutes</span> to ryerson
            </div>
        	...
        	<div class="tp-caption tp-resizeme color-white textBG"
                ...
                data-responsive_offset="on"
                style="z-index: 6; white-space: nowrap; letter-spacing:1px;">
                <span style="font-family: 'HelveticaNeueLTStd-Bd';">7 minutes</span> to dundas subway station
            </div>
        	...
        	<div class="tp-caption tp-resizeme color-white textBG"
                ...
                data-responsive_offset="on"
                style="z-index: 6; white-space: nowrap; letter-spacing:1px;">
                <span style="font-family: 'HelveticaNeueLTStd-Bd';">7 minutes</span> to eaton centre and yonge-dundas square
            </div>
        	...
        	<div class="tp-caption tp-resizeme color-white textBG"
                ...
                data-responsive_offset="on"
                style="z-index: 6; white-space: nowrap; letter-spacing:1px;">
                <span style="font-family: 'HelveticaNeueLTStd-Bd';">4 minutes</span> to loblaws
            </div>
        	...
        	<div class="tp-caption tp-resizeme color-white textBG"
                ...
                data-basealign="slide"
                data-responsive_offset="on"
                style="z-index: 6; white-space: nowrap; letter-spacing:1px; text-align:center !important;">
                <span style="font-family: 'HelveticaNeueLTStd-Bd';">2 minutes</span> to more amazing restaurants<br/>
                than you can count
            </div>
      </li>
      <!-- End Slide -->
            ...
            <!-- Slide -->
      <li data-transition="fade" data-slotamount="7" data-easein="Power4.easeInOut" data-easeout="Power4.easeInOut" data-masterspeed="1000" data-rotate="0" data-saveperformance="off" data-title="Landing Page Slide" >
            <!-- Main Image -->
            	<div class="Pattern"></div>
      ...
      <!-- Slide -->
		<li data-transition="fade" data-slotamount="7" data-easein="Power4.easeInOut" data-easeout="Power4.easeInOut" data-masterspeed="1000" data-rotate="0" data-saveperformance="off" data-delay="4000" data-title="Landing Page Slide" >
            <!-- Main Image -->
            <div class="Pattern"></div>
            <img src="images/LandingImage2.jpg" alt="Ivy Image" data-bgposition="right center" data-kenburns="on" data-duration="1" data-ease="Linear.easeNone" data-scalestart="100" data-scaleend="109" data-rotatestart="0" data-rotateend="0" data-offsetstart="0 0" data-offsetend="0 500" data-bgparallax="10" class="rev-slidebg" data-no-retina>
			<div class="tp-caption tp-resizeme color-white textBG"
                ...
                data-responsive_offset="on"
                style="z-index: 6; white-space: nowrap; letter-spacing:1px;">
                <span style="font-family: 'HelveticaNeueLTStd-Bd';">plant yourself here</span>
			</div>
		</li>
		...
		<li data-transition="fade" data-slotamount="7" data-easein="Power4.easeInOut" data-easeout="Power4.easeInOut" data-masterspeed="1000" data-rotate="0" data-saveperformance="off" data-title="Landing Page Slide">
            ...
            <div class="tp-caption tp-resizeme color-white textBG"
                ...
                data-responsive_offset="on"
                style="z-index: 6; white-space: nowrap; letter-spacing:1px;">
                a fresh approach to downtown living
            </div>
            <div class="tp-caption tp-resizeme color-white textBG"
                data-x="['center','center','center','center']" data-hoffset="['0,'0','0','0']"
                data-y="['middle','middle','middle','middle']" data-voffset="['22','22','22','52']"
                data-fontsize="['31','31','31','21']"
                data-lineheight="['32','32','32','22']"
                data-width="none"
                data-height="none"
                ...
                data-responsive_offset="on"
                style="z-index: 6; white-space: nowrap; letter-spacing:1px;">
                <span style="font-family: 'HelveticaNeueLTStd-Bd';">condos from the low $300s</span>
            </div>
        </li>
        <!-- End Slide -->
            ...
            <div class="formBlock">
                ...
                <div class="formElement end additionalSpace">
                    <div class="formRow fullrow optin">
                        ...
                        Yes, I'd like to receive more information about IVY and other projects from The Sher Corporation, Dream or Trend Network. You are able to unsubscribe at any time.</div>
                    </div>
                </div>
