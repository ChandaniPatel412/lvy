...
function registrationReceipt($adminArray, $emailR_body)
{
/*
...
*  $from_name="My Name";
*/
	$from_name = $adminArray['projectName'];
    $from_address = $adminArray['projectOriginEmail'];
    $reply_name = $adminArray['recipient_name'];
    $reply_address = $adminArray['recipient_email'];
    $error_delivery_name = $from_name;
    $error_delivery_address = $adminArray['projectErrorEmail'];
	
/*
*  Change these lines /per project
*/
    $to_name = $adminArray['projectName'];
    $to_address = $adminArray['reciept_recipients'];
	$subject = $adminArray['projectName']." : ".$adminArray['reciept_subject'];

    $email_message=new email_message_class;
    $email_message->SetMultipleEncodedEmailHeader("To",$adminArray['reciept_recipients']);
    $email_message->SetEncodedEmailHeader("From",$from_address,$from_name);
    $email_message->SetEncodedEmailHeader("Reply-To",$reply_address,$reply_name);
   	$email_message->SetMultipleEncodedEmailHeader("Bcc", $adminArray['admin_recipients']);
