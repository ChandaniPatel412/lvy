...
$cryptwidth  = 85;  // Largeur du cryptogramme (en pixels)
$cryptheight = 35;   // Hauteur du cryptogramme (en pixels)

$bgR  = 201;         // Couleur du fond au format RGB: Red (0->255)
$bgG  = 219;         // Couleur du fond au format RGB: Green (0->255)
$bgB  = 94;         // Couleur du fond au format RGB: Blue (0->255)
...
$difuplow = true;          // Différencie les Maj/Min lors de la saisie du code (true, false)
...
$noisepxmax = 4;      // Bruit: Nb maximum de pixels aléatoires
