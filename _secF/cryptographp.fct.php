...
// -----------------------------------------------
 ...
 echo "<table><tr><td><img id='cryptogram' src='/_secF/cryptographp.php?cfg=".$cfg."&".SID."'></td>";
 if ($reload) echo "<td><a title='".($reload==1?'':$reload)."' style=\"cursor:pointer\" onclick=\"javascript:document.images.cryptogram.src='/_secF/cryptographp.php?cfg=".$cfg."&".SID."&'+Math.round(Math.random(0)*1000)+1\"><img src=\"/_secF/images/reload.png\"></a></td>";
 echo "</tr></table>";
 }
