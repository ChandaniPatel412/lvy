...
// Pano2VR 5.0.3/15088
// Filename: simplex_v13.ggsk
// Generated Wed Dec 14 14:16:37 2016
...
function pano2vrSkin(player,base) {
	...
	this.addSkin=function() {
		...
		this._controller.ggUpdateConditionTimer=function () {
			...
			if (
				(me.player.getViewerSize().width <= 980) || 
			...
			if (me._controller.ggCurrentLogicStatePosition != newLogicStatePosition) {
				...
				if (me._controller.ggCurrentLogicStatePosition == 0) {
					me._controller.style.left='-174px';
					me._controller.ggTop=-65;
					me._controller.ggUpdatePosition();
				}
				else {
					me._controller.style.left='7px';
		...
		this._tt_zoomin_1=document.createElement('div');
		this._tt_zoomin_1__text=document.createElement('div');
		this._tt_zoomin_1.className='ggskin ggskin_textdiv';
		this._tt_zoomin_1.ggTextDiv=this._tt_zoomin_1__text;
		this._tt_zoomin_1.ggId="tt_zoomin_1";
		this._tt_zoomin_1.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
		this._tt_zoomin_1.ggVisible=false;
		this._tt_zoomin_1.className='ggskin ggskin_text ';
		this._tt_zoomin_1.ggType='text';
		hs ='';
		hs+='height : 18px;';
		hs+='left : -44px;';
		hs+='position : absolute;';
		...
		hs+='width : 148px;';
		this._tt_zoomin_1.setAttribute('style',hs);
		this._tt_zoomin_1.style[domTransform + 'Origin']='50% 50%';
		hs ='position:absolute;';
		hs+='left: 0px;';
		hs+='top:  0px;';
		hs+='width: 148px;';
		...
		hs+='overflow: hidden;';
		this._tt_zoomin_1__text.setAttribute('style',hs);
		this._tt_zoomin_1__text.innerHTML="zoom in";
		this._tt_zoomin_1.appendChild(this._tt_zoomin_1__text);
		me._tt_zoomin_1.ggIsActive=function() {
			if ((this.parentNode) && (this.parentNode.ggIsActive)) {
				return this.parentNode.ggIsActive();
			}
			return false;
		}
		me._tt_zoomin_1.ggElementNodeId=function() {
			if ((this.parentNode) && (this.parentNode.ggElementNodeId)) {
				return this.parentNode.ggElementNodeId();
			}
			return me.player.getCurrentNode();
		}
		me._tt_zoomin_1.ggCurrentLogicStateVisible = -1;
		this._tt_zoomin_1.ggUpdateConditionTimer=function () {
			var newLogicStateVisible;
			if (
				(me.elementMouseOver['zoomin'] == true) && 
			...
			if (me._tt_zoomin_1.ggCurrentLogicStateVisible != newLogicStateVisible) {
				me._tt_zoomin_1.ggCurrentLogicStateVisible = newLogicStateVisible;
				me._tt_zoomin_1.style[domTransition]='';
				if (me._tt_zoomin_1.ggCurrentLogicStateVisible == 0) {
					me._tt_zoomin_1.style.visibility=(Number(me._tt_zoomin_1.style.opacity)>0||!me._tt_zoomin_1.style.opacity)?'inherit':'hidden';
					me._tt_zoomin_1.ggVisible=true;
				}
				else {
					me._tt_zoomin_1.style.visibility="hidden";
					me._tt_zoomin_1.ggVisible=false;
				}
			}
		}
		this._tt_zoomin_1.ggUpdatePosition=function () {
		}
		this._tt_zoomin_white_1=document.createElement('div');
		this._tt_zoomin_white_1__text=document.createElement('div');
		this._tt_zoomin_white_1.className='ggskin ggskin_textdiv';
		this._tt_zoomin_white_1.ggTextDiv=this._tt_zoomin_white_1__text;
		this._tt_zoomin_white_1.ggId="tt_zoomin_white_1";
		this._tt_zoomin_white_1.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
		this._tt_zoomin_white_1.ggVisible=true;
		this._tt_zoomin_white_1.className='ggskin ggskin_text ';
		this._tt_zoomin_white_1.ggType='text';
		hs ='';
		hs+='height : 18px;';
		hs+='left : 0px;';
		hs+='position : absolute;';
		...
		hs+='visibility : inherit;';
		hs+='width : 148px;';
		this._tt_zoomin_white_1.setAttribute('style',hs);
		this._tt_zoomin_white_1.style[domTransform + 'Origin']='50% 50%';
		hs ='position:absolute;';
		hs+='left: 0px;';
		hs+='top:  0px;';
		hs+='width: 148px;';
		...
		hs+='padding: 0px 1px 0px 1px;';
		hs+='overflow: hidden;';
		this._tt_zoomin_white_1__text.setAttribute('style',hs);
		this._tt_zoomin_white_1__text.innerHTML="zoom in";
		this._tt_zoomin_white_1.appendChild(this._tt_zoomin_white_1__text);
		me._tt_zoomin_white_1.ggIsActive=function() {
			if ((this.parentNode) && (this.parentNode.ggIsActive)) {
				return this.parentNode.ggIsActive();
			}
			return false;
		}
		me._tt_zoomin_white_1.ggElementNodeId=function() {
			if ((this.parentNode) && (this.parentNode.ggElementNodeId)) {
				return this.parentNode.ggElementNodeId();
			}
			return me.player.getCurrentNode();
		}
		this._tt_zoomin_white_1.ggUpdatePosition=function () {
		}
		this._tt_zoomin_1.appendChild(this._tt_zoomin_white_1);
		this._zoomin.appendChild(this._tt_zoomin_1);
		...
		me._button_simplex_auto_rotate.ggCurrentLogicStateVisible = -1;
		this._button_simplex_auto_rotate.ggUpdateConditionTimer=function () {
			var newLogicStateVisible;
			if (
				(me.player.getViewerSize().width <= 980) || 
				(me.player.getIsMobile() == true)
			...
			if (me._button_simplex_auto_rotate.ggCurrentLogicStateVisible != newLogicStateVisible) {
				me._button_simplex_auto_rotate.ggCurrentLogicStateVisible = newLogicStateVisible;
				me._button_simplex_auto_rotate.style[domTransition]='';
				if (me._button_simplex_auto_rotate.ggCurrentLogicStateVisible == 0) {
					me._button_simplex_auto_rotate.style.visibility="hidden";
					me._button_simplex_auto_rotate.ggVisible=false;
				}
				else {
					me._button_simplex_auto_rotate.style.visibility=(Number(me._button_simplex_auto_rotate.style.opacity)>0||!me._button_simplex_auto_rotate.style.opacity)?'inherit':'hidden';
					me._button_simplex_auto_rotate.ggVisible=true;
				}
			}
		}
		...
		this._tt_start_auto_rotate.onmouseover=function () {
			me.elementMouseOver['tt_start_auto_rotate']=true;
		}
		this._tt_start_auto_rotate.onmouseout=function () {
			me.elementMouseOver['tt_start_auto_rotate']=false;
		}
		this._tt_start_auto_rotate.ontouchend=function () {
			me.elementMouseOver['tt_start_auto_rotate']=false;
		}
		...
		this._tt_start_auto_rotate.appendChild(this._tt_zoomin);
		...
		this._button_image_normalscreen.ggLeft=-88;
		...
		this._button_image_fullscreen.ggLeft=-88;
		...
		this._dusktime_buttons=document.createElement('div');
		this._dusktime_buttons.ggId="Dusktime Buttons";
		this._dusktime_buttons.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
		this._dusktime_buttons.ggVisible=false;
		this._dusktime_buttons.className='ggskin ggskin_container ';
		this._dusktime_buttons.ggType='container';
		hs ='';
		hs+='height : 48px;';
		hs+='left : 21px;';
		hs+='position : absolute;';
		...
		hs+='visibility : hidden;';
		hs+='width : 260px;';
		this._dusktime_buttons.setAttribute('style',hs);
		this._dusktime_buttons.style[domTransform + 'Origin']='50% 50%';
		me._dusktime_buttons.ggIsActive=function() {
			return false;
		}
		me._dusktime_buttons.ggElementNodeId=function() {
			return me.player.getCurrentNode();
		}
		this._dusktime_buttons.onclick=function () {
			me.player.openNext("{node1}","");
			me._dusktime_buttons.style[domTransition]='none';
			me._dusktime_buttons.style.visibility='hidden';
			me._dusktime_buttons.ggVisible=false;
			me._daytime_buttons.style[domTransition]='none';
			me._daytime_buttons.style.visibility=(Number(me._daytime_buttons.style.opacity)>0||!me._daytime_buttons.style.opacity)?'inherit':'hidden';
			me._daytime_buttons.ggVisible=true;
		}
		me._dusktime_buttons.ggCurrentLogicStateVisible = -1;
		this._dusktime_buttons.ggUpdateConditionResize=function () {
			var newLogicStateVisible;
			if (
				(me.player.getViewerSize().width <= 584)
			)
			{
				newLogicStateVisible = 0;
			}
			...
			if (me._dusktime_buttons.ggCurrentLogicStateVisible != newLogicStateVisible) {
				me._dusktime_buttons.ggCurrentLogicStateVisible = newLogicStateVisible;
				me._dusktime_buttons.style[domTransition]='';
				if (me._dusktime_buttons.ggCurrentLogicStateVisible == 0) {
					me._dusktime_buttons.style.visibility="hidden";
					me._dusktime_buttons.ggVisible=false;
				}
				else {
		...
		this._dusktime_buttons.ggUpdatePosition=function () {
			me._dusktime_buttons.ggUpdateConditionResize();
		}
		...
		this._button_20__img.setAttribute('style','position: absolute;top: 0px;left: 0px;width: 100%;height: 100%;-webkit-user-drag:none;pointer-events:none;');
		this._button_20__img.className='ggskin ggskin_button';
		...
		this._button_20.style[domTransform + 'Origin']='50% 50%';
		...
		me._button_20.ggElementNodeId=function() {
			if ((this.parentNode) && (this.parentNode.ggElementNodeId)) {
				return this.parentNode.ggElementNodeId();
			}
			return me.player.getCurrentNode();
		...
		this._button_20.onmouseover=function () {
			me.elementMouseOver['button_20']=true;
		}
		this._button_20.onmouseout=function () {
			me.elementMouseOver['button_20']=false;
		}
		this._button_20.ontouchend=function () {
			me.elementMouseOver['button_20']=false;
		}
		this._button_20.ggUpdatePosition=function () {
		}
		this._viewday10=document.createElement('div');
		this._viewday10__text=document.createElement('div');
		this._viewday10.className='ggskin ggskin_textdiv';
		this._viewday10.ggTextDiv=this._viewday10__text;
		this._viewday10.ggId="ViewDay1";
		this._viewday10.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
		this._viewday10.ggVisible=true;
		this._viewday10.className='ggskin ggskin_text ';
		this._viewday10.ggType='text';
		hs ='';
		hs+='height : 40px;';
		hs+='left : 35px;';
		hs+='position : absolute;';
		...
		hs+='visibility : inherit;';
		hs+='width : 318px;';
		this._viewday10.setAttribute('style',hs);
		this._viewday10.style[domTransform + 'Origin']='50% 50%';
		hs ='position:absolute;';
		hs+='left: 0px;';
		hs+='top:  0px;';
		hs+='width: 318px;';
		...
		hs+='padding: 0px 1px 0px 1px;';
		hs+='overflow: hidden;';
		this._viewday10__text.setAttribute('style',hs);
		this._viewday10__text.innerHTML="click to see daytime view<br\/>from the 32nd floor";
		this._viewday10.appendChild(this._viewday10__text);
		me._viewday10.ggIsActive=function() {
			if ((this.parentNode) && (this.parentNode.ggIsActive)) {
				return this.parentNode.ggIsActive();
			}
			return false;
		}
		me._viewday10.ggElementNodeId=function() {
			if ((this.parentNode) && (this.parentNode.ggElementNodeId)) {
				return this.parentNode.ggElementNodeId();
			}
			return me.player.getCurrentNode();
		}
		me._viewday10.ggCurrentLogicStateVisible = -1;
		this._viewday10.ggUpdateConditionTimer=function () {
			var newLogicStateVisible;
			if (
				(me.elementMouseOver['button_20'] == true) && 
				(me.player.getIsMobile() == false)
			...
			if (me._viewday10.ggCurrentLogicStateVisible != newLogicStateVisible) {
				me._viewday10.ggCurrentLogicStateVisible = newLogicStateVisible;
				me._viewday10.style[domTransition]='';
				if (me._viewday10.ggCurrentLogicStateVisible == 0) {
					me._viewday10.style.visibility=(Number(me._viewday10.style.opacity)>0||!me._viewday10.style.opacity)?'inherit':'hidden';
					me._viewday10.ggVisible=true;
				}
				else {
					me._viewday10.style.visibility=(Number(me._viewday10.style.opacity)>0||!me._viewday10.style.opacity)?'inherit':'hidden';
					me._viewday10.ggVisible=true;
		...
		this._viewday10.ggUpdatePosition=function () {
		}
		this._viewday20=document.createElement('div');
		this._viewday20__text=document.createElement('div');
		this._viewday20.className='ggskin ggskin_textdiv';
		this._viewday20.ggTextDiv=this._viewday20__text;
		this._viewday20.ggId="ViewDay2";
		this._viewday20.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
		this._viewday20.ggVisible=true;
		this._viewday20.className='ggskin ggskin_text ';
		this._viewday20.ggType='text';
		hs ='';
		hs+='height : 40px;';
		hs+='left : 0px;';
		hs+='position : absolute;';
		...
		hs+='visibility : inherit;';
		hs+='width : 318px;';
		this._viewday20.setAttribute('style',hs);
		this._viewday20.style[domTransform + 'Origin']='50% 50%';
		hs ='position:absolute;';
		hs+='left: 0px;';
		hs+='top:  0px;';
		hs+='width: 318px;';
		...
		hs+='padding: 0px 1px 0px 1px;';
		hs+='overflow: hidden;';
		this._viewday20__text.setAttribute('style',hs);
		this._viewday20__text.innerHTML="click to see daytime view<br\/>from the 32nd floor";
		this._viewday20.appendChild(this._viewday20__text);
		me._viewday20.ggIsActive=function() {
			if ((this.parentNode) && (this.parentNode.ggIsActive)) {
				return this.parentNode.ggIsActive();
			}
			return false;
		}
		me._viewday20.ggElementNodeId=function() {
			if ((this.parentNode) && (this.parentNode.ggElementNodeId)) {
				return this.parentNode.ggElementNodeId();
			}
			return me.player.getCurrentNode();
		}
		this._viewday20.ggUpdatePosition=function () {
		}
		this._viewday10.appendChild(this._viewday20);
		this._button_20.appendChild(this._viewday10);
		this._dusktime_buttons.appendChild(this._button_20);
		this.divSkin.appendChild(this._dusktime_buttons);
		this._daytime_buttons=document.createElement('div');
		this._daytime_buttons.ggId="Daytime Buttons";
		this._daytime_buttons.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
		this._daytime_buttons.ggVisible=true;
		this._daytime_buttons.className='ggskin ggskin_container ';
		this._daytime_buttons.ggType='container';
		hs ='';
		hs+='height : 48px;';
		hs+='left : 21px;';
		hs+='position : absolute;';
		...
		hs+='visibility : inherit;';
		hs+='width : 260px;';
		this._daytime_buttons.setAttribute('style',hs);
		this._daytime_buttons.style[domTransform + 'Origin']='50% 50%';
		me._daytime_buttons.ggIsActive=function() {
			return false;
		}
		me._daytime_buttons.ggElementNodeId=function() {
			return me.player.getCurrentNode();
		}
		this._daytime_buttons.onclick=function () {
			me.player.openNext("{node2}","");
			me._daytime_buttons.style[domTransition]='none';
			me._daytime_buttons.style.visibility='hidden';
			me._daytime_buttons.ggVisible=false;
			me._dusktime_buttons.style[domTransition]='none';
			me._dusktime_buttons.style.visibility=(Number(me._dusktime_buttons.style.opacity)>0||!me._dusktime_buttons.style.opacity)?'inherit':'hidden';
			me._dusktime_buttons.ggVisible=true;
		}
		me._daytime_buttons.ggCurrentLogicStateVisible = -1;
		this._daytime_buttons.ggUpdateConditionResize=function () {
			var newLogicStateVisible;
			if (
				(me.player.getViewerSize().width <= 584)
			)
			...
			if (me._daytime_buttons.ggCurrentLogicStateVisible != newLogicStateVisible) {
				me._daytime_buttons.ggCurrentLogicStateVisible = newLogicStateVisible;
				me._daytime_buttons.style[domTransition]='';
				if (me._daytime_buttons.ggCurrentLogicStateVisible == 0) {
					me._daytime_buttons.style.visibility="hidden";
					me._daytime_buttons.ggVisible=false;
				}
				else {
		...
		this._daytime_buttons.ggUpdatePosition=function () {
			me._daytime_buttons.ggUpdateConditionResize();
		}
		...
		this._button_10__img.setAttribute('style','position: absolute;top: 0px;left: 0px;width: 100%;height: 100%;-webkit-user-drag:none;pointer-events:none;');
		this._button_10__img.className='ggskin ggskin_button';
		...
		this._button_10.style[domTransform + 'Origin']='50% 50%';
		...
		me._button_10.ggElementNodeId=function() {
			if ((this.parentNode) && (this.parentNode.ggElementNodeId)) {
				return this.parentNode.ggElementNodeId();
			}
			return me.player.getCurrentNode();
		...
		this._viewdusk10=document.createElement('div');
		this._viewdusk10__text=document.createElement('div');
		this._viewdusk10.className='ggskin ggskin_textdiv';
		this._viewdusk10.ggTextDiv=this._viewdusk10__text;
		this._viewdusk10.ggId="ViewDusk1";
		this._viewdusk10.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
		this._viewdusk10.ggVisible=true;
		this._viewdusk10.className='ggskin ggskin_text ';
		this._viewdusk10.ggType='text';
		hs ='';
		hs+='height : 40px;';
		hs+='left : 35px;';
		hs+='position : absolute;';
		...
		hs+='visibility : inherit;';
		hs+='width : 318px;';
		this._viewdusk10.setAttribute('style',hs);
		this._viewdusk10.style[domTransform + 'Origin']='50% 50%';
		hs ='position:absolute;';
		hs+='left: 0px;';
		hs+='top:  0px;';
		hs+='width: 318px;';
		...
		hs+='padding: 0px 1px 0px 1px;';
		hs+='overflow: hidden;';
		this._viewdusk10__text.setAttribute('style',hs);
		this._viewdusk10__text.innerHTML="click to see view at dusk<br\/>from the 32nd floor";
		this._viewdusk10.appendChild(this._viewdusk10__text);
		me._viewdusk10.ggIsActive=function() {
			if ((this.parentNode) && (this.parentNode.ggIsActive)) {
				return this.parentNode.ggIsActive();
			}
			return false;
		}
		me._viewdusk10.ggElementNodeId=function() {
			if ((this.parentNode) && (this.parentNode.ggElementNodeId)) {
				return this.parentNode.ggElementNodeId();
			}
			return me.player.getCurrentNode();
		}
		me._viewdusk10.ggCurrentLogicStateVisible = -1;
		this._viewdusk10.ggUpdateConditionTimer=function () {
			var newLogicStateVisible;
			if (
				(me.elementMouseOver['button_10'] == true) && 
				(me.player.getIsMobile() == false)
			...
			if (me._viewdusk10.ggCurrentLogicStateVisible != newLogicStateVisible) {
				me._viewdusk10.ggCurrentLogicStateVisible = newLogicStateVisible;
				me._viewdusk10.style[domTransition]='';
				if (me._viewdusk10.ggCurrentLogicStateVisible == 0) {
					me._viewdusk10.style.visibility=(Number(me._viewdusk10.style.opacity)>0||!me._viewdusk10.style.opacity)?'inherit':'hidden';
					me._viewdusk10.ggVisible=true;
				}
				else {
					me._viewdusk10.style.visibility=(Number(me._viewdusk10.style.opacity)>0||!me._viewdusk10.style.opacity)?'inherit':'hidden';
					me._viewdusk10.ggVisible=true;
		...
		this._viewdusk10.ggUpdatePosition=function () {
		}
		this._viewdusk20=document.createElement('div');
		this._viewdusk20__text=document.createElement('div');
		this._viewdusk20.className='ggskin ggskin_textdiv';
		this._viewdusk20.ggTextDiv=this._viewdusk20__text;
		this._viewdusk20.ggId="ViewDusk2";
		this._viewdusk20.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
		this._viewdusk20.ggVisible=true;
		this._viewdusk20.className='ggskin ggskin_text ';
		this._viewdusk20.ggType='text';
		hs ='';
		hs+='height : 40px;';
		hs+='left : 0px;';
		hs+='position : absolute;';
		...
		hs+='visibility : inherit;';
		hs+='width : 318px;';
		this._viewdusk20.setAttribute('style',hs);
		this._viewdusk20.style[domTransform + 'Origin']='50% 50%';
		hs ='position:absolute;';
		hs+='left: 0px;';
		hs+='top:  0px;';
		hs+='width: 318px;';
		...
		hs+='padding: 0px 1px 0px 1px;';
		hs+='overflow: hidden;';
		this._viewdusk20__text.setAttribute('style',hs);
		this._viewdusk20__text.innerHTML="click to see view at dusk<br\/>from the 32nd floor";
		this._viewdusk20.appendChild(this._viewdusk20__text);
		me._viewdusk20.ggIsActive=function() {
			if ((this.parentNode) && (this.parentNode.ggIsActive)) {
				return this.parentNode.ggIsActive();
			}
			return false;
		}
		me._viewdusk20.ggElementNodeId=function() {
			if ((this.parentNode) && (this.parentNode.ggElementNodeId)) {
				return this.parentNode.ggElementNodeId();
			}
			return me.player.getCurrentNode();
		}
		this._viewdusk20.ggUpdatePosition=function () {
		}
		this._viewdusk10.appendChild(this._viewdusk20);
		this._button_10.appendChild(this._viewdusk10);
		this._daytime_buttons.appendChild(this._button_10);
		this.divSkin.appendChild(this._daytime_buttons);
		this._dusktime_buttons_small=document.createElement('div');
		this._dusktime_buttons_small.ggId="Dusktime Buttons Small";
		this._dusktime_buttons_small.ggLeft=-158;
		this._dusktime_buttons_small.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
		this._dusktime_buttons_small.ggVisible=false;
		this._dusktime_buttons_small.className='ggskin ggskin_container ';
		this._dusktime_buttons_small.ggType='container';
		hs ='';
		hs+='height : 56px;';
		hs+='left : -158px;';
		hs+='position : absolute;';
		...
		hs+='visibility : hidden;';
		hs+='width : 200px;';
		this._dusktime_buttons_small.setAttribute('style',hs);
		this._dusktime_buttons_small.style[domTransform + 'Origin']='50% 50%';
		me._dusktime_buttons_small.ggIsActive=function() {
			return false;
		}
		me._dusktime_buttons_small.ggElementNodeId=function() {
			return me.player.getCurrentNode();
		}
		this._dusktime_buttons_small.onclick=function () {
			me.player.openNext("{node1}","");
			me._dusktime_buttons_small.style[domTransition]='none';
			me._dusktime_buttons_small.style.visibility='hidden';
			me._dusktime_buttons_small.ggVisible=false;
			me._daytime_buttons_small.style[domTransition]='none';
			me._daytime_buttons_small.style.visibility=(Number(me._daytime_buttons_small.style.opacity)>0||!me._daytime_buttons_small.style.opacity)?'inherit':'hidden';
			me._daytime_buttons_small.ggVisible=true;
		}
		me._dusktime_buttons_small.ggCurrentLogicStateVisible = -1;
		this._dusktime_buttons_small.ggUpdateConditionTimer=function () {
			var newLogicStateVisible;
			if (
				(me.player.getViewerSize().width > 584)
			)
			...
			if (me._dusktime_buttons_small.ggCurrentLogicStateVisible != newLogicStateVisible) {
				me._dusktime_buttons_small.ggCurrentLogicStateVisible = newLogicStateVisible;
				me._dusktime_buttons_small.style[domTransition]='';
				if (me._dusktime_buttons_small.ggCurrentLogicStateVisible == 0) {
					me._dusktime_buttons_small.style.visibility="hidden";
					me._dusktime_buttons_small.ggVisible=false;
				}
				else if (me._dusktime_buttons_small.ggCurrentLogicStateVisible == 1) {
					me._dusktime_buttons_small.style.visibility="hidden";
					me._dusktime_buttons_small.ggVisible=false;
				}
				else {
		...
		this._dusktime_buttons_small.ggUpdatePosition=function () {
			this.style[domTransition]='none';
			if (this.parentNode) {
				var w=this.parentNode.offsetWidth;
					this.style.left=(this.ggLeft - 0 + w) + 'px';
		...
		this._viewday1=document.createElement('div');
		this._viewday1__text=document.createElement('div');
		this._viewday1.className='ggskin ggskin_textdiv';
		this._viewday1.ggTextDiv=this._viewday1__text;
		this._viewday1.ggId="ViewDay1";
		this._viewday1.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
		this._viewday1.ggVisible=true;
		this._viewday1.className='ggskin ggskin_text ';
		this._viewday1.ggType='text';
		hs ='';
		hs+='height : 56px;';
		hs+='left : 35px;';
		hs+='position : absolute;';
		...
		hs+='visibility : inherit;';
		hs+='width : 198px;';
		this._viewday1.setAttribute('style',hs);
		this._viewday1.style[domTransform + 'Origin']='50% 50%';
		hs ='position:absolute;';
		hs+='left: 0px;';
		hs+='top:  0px;';
		hs+='width: 198px;';
		...
		hs+='padding: 0px 1px 0px 1px;';
		hs+='overflow: hidden;';
		this._viewday1__text.setAttribute('style',hs);
		this._viewday1__text.innerHTML="click to see<br\/>daytime view<br\/>from the 32nd floor";
		this._viewday1.appendChild(this._viewday1__text);
		me._viewday1.ggIsActive=function() {
			if ((this.parentNode) && (this.parentNode.ggIsActive)) {
				return this.parentNode.ggIsActive();
			}
			return false;
		}
		me._viewday1.ggElementNodeId=function() {
			if ((this.parentNode) && (this.parentNode.ggElementNodeId)) {
				return this.parentNode.ggElementNodeId();
			}
			return me.player.getCurrentNode();
		}
		me._viewday1.ggCurrentLogicStateVisible = -1;
		this._viewday1.ggUpdateConditionTimer=function () {
			var newLogicStateVisible;
			if (
				(me.elementMouseOver['button_2'] == true) && 
				(me.player.getIsMobile() == false)
			...
			if (me._viewday1.ggCurrentLogicStateVisible != newLogicStateVisible) {
				me._viewday1.ggCurrentLogicStateVisible = newLogicStateVisible;
				me._viewday1.style[domTransition]='';
				if (me._viewday1.ggCurrentLogicStateVisible == 0) {
					me._viewday1.style.visibility=(Number(me._viewday1.style.opacity)>0||!me._viewday1.style.opacity)?'inherit':'hidden';
					me._viewday1.ggVisible=true;
				}
				else {
					me._viewday1.style.visibility=(Number(me._viewday1.style.opacity)>0||!me._viewday1.style.opacity)?'inherit':'hidden';
					me._viewday1.ggVisible=true;
		...
		this._viewday1.ggUpdatePosition=function () {
		}
		this._viewday2=document.createElement('div');
		this._viewday2__text=document.createElement('div');
		this._viewday2.className='ggskin ggskin_textdiv';
		this._viewday2.ggTextDiv=this._viewday2__text;
		this._viewday2.ggId="ViewDay2";
		this._viewday2.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
		this._viewday2.ggVisible=true;
		this._viewday2.className='ggskin ggskin_text ';
		this._viewday2.ggType='text';
		hs ='';
		hs+='height : 56px;';
		hs+='left : 0px;';
		hs+='position : absolute;';
		...
		hs+='visibility : inherit;';
		hs+='width : 198px;';
		this._viewday2.setAttribute('style',hs);
		this._viewday2.style[domTransform + 'Origin']='50% 50%';
		hs ='position:absolute;';
		hs+='left: 0px;';
		hs+='top:  0px;';
		hs+='width: 198px;';
		...
		hs+='padding: 0px 1px 0px 1px;';
		hs+='overflow: hidden;';
		this._viewday2__text.setAttribute('style',hs);
		this._viewday2__text.innerHTML="click to see<br\/>daytime view<br\/>from the 32nd floor";
		this._viewday2.appendChild(this._viewday2__text);
		me._viewday2.ggIsActive=function() {
			if ((this.parentNode) && (this.parentNode.ggIsActive)) {
				return this.parentNode.ggIsActive();
			}
			return false;
		}
		me._viewday2.ggElementNodeId=function() {
			if ((this.parentNode) && (this.parentNode.ggElementNodeId)) {
				return this.parentNode.ggElementNodeId();
			}
			return me.player.getCurrentNode();
		}
		this._viewday2.ggUpdatePosition=function () {
		}
		this._viewday1.appendChild(this._viewday2);
		this._button_2.appendChild(this._viewday1);
		this._dusktime_buttons_small.appendChild(this._button_2);
		this.divSkin.appendChild(this._dusktime_buttons_small);
		this._daytime_buttons_small=document.createElement('div');
		this._daytime_buttons_small.ggId="Daytime Buttons Small";
		this._daytime_buttons_small.ggLeft=-158;
		this._daytime_buttons_small.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
		this._daytime_buttons_small.ggVisible=true;
		this._daytime_buttons_small.className='ggskin ggskin_container ';
		this._daytime_buttons_small.ggType='container';
		hs ='';
		hs+='height : 56px;';
		hs+='left : -158px;';
		hs+='position : absolute;';
		...
		hs+='visibility : inherit;';
		hs+='width : 200px;';
		this._daytime_buttons_small.setAttribute('style',hs);
		this._daytime_buttons_small.style[domTransform + 'Origin']='50% 50%';
		me._daytime_buttons_small.ggIsActive=function() {
			return false;
		}
		me._daytime_buttons_small.ggElementNodeId=function() {
			return me.player.getCurrentNode();
		}
		this._daytime_buttons_small.onclick=function () {
			me.player.openNext("{node2}","");
			me._daytime_buttons_small.style[domTransition]='none';
			me._daytime_buttons_small.style.visibility='hidden';
			me._daytime_buttons_small.ggVisible=false;
			me._dusktime_buttons_small.style[domTransition]='none';
			me._dusktime_buttons_small.style.visibility=(Number(me._dusktime_buttons_small.style.opacity)>0||!me._dusktime_buttons_small.style.opacity)?'inherit':'hidden';
			me._dusktime_buttons_small.ggVisible=true;
		}
		me._daytime_buttons_small.ggCurrentLogicStateVisible = -1;
		this._daytime_buttons_small.ggUpdateConditionTimer=function () {
			var newLogicStateVisible;
			if (
				(me.player.getViewerSize().width > 584)
			)
			...
			if (me._daytime_buttons_small.ggCurrentLogicStateVisible != newLogicStateVisible) {
				me._daytime_buttons_small.ggCurrentLogicStateVisible = newLogicStateVisible;
				me._daytime_buttons_small.style[domTransition]='';
				if (me._daytime_buttons_small.ggCurrentLogicStateVisible == 0) {
					me._daytime_buttons_small.style.visibility="hidden";
					me._daytime_buttons_small.ggVisible=false;
				}
				else if (me._daytime_buttons_small.ggCurrentLogicStateVisible == 1) {
					me._daytime_buttons_small.style.visibility=(Number(me._daytime_buttons_small.style.opacity)>0||!me._daytime_buttons_small.style.opacity)?'inherit':'hidden';
					me._daytime_buttons_small.ggVisible=true;
				}
				else {
		...
		this._daytime_buttons_small.ggUpdatePosition=function () {
			this.style[domTransition]='none';
			if (this.parentNode) {
				var w=this.parentNode.offsetWidth;
					this.style.left=(this.ggLeft - 0 + w) + 'px';
		...
		this._viewdusk1=document.createElement('div');
		this._viewdusk1__text=document.createElement('div');
		this._viewdusk1.className='ggskin ggskin_textdiv';
		this._viewdusk1.ggTextDiv=this._viewdusk1__text;
		this._viewdusk1.ggId="ViewDusk1";
		this._viewdusk1.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
		this._viewdusk1.ggVisible=true;
		this._viewdusk1.className='ggskin ggskin_text ';
		this._viewdusk1.ggType='text';
		hs ='';
		hs+='height : 56px;';
		hs+='left : 35px;';
		hs+='position : absolute;';
		...
		hs+='visibility : inherit;';
		hs+='width : 198px;';
		this._viewdusk1.setAttribute('style',hs);
		this._viewdusk1.style[domTransform + 'Origin']='50% 50%';
		hs ='position:absolute;';
		hs+='left: 0px;';
		hs+='top:  0px;';
		hs+='width: 198px;';
		...
		hs+='padding: 0px 1px 0px 1px;';
		hs+='overflow: hidden;';
		this._viewdusk1__text.setAttribute('style',hs);
		this._viewdusk1__text.innerHTML="click to see view<br\/>at dusk from the<br\/>32nd floor";
		this._viewdusk1.appendChild(this._viewdusk1__text);
		me._viewdusk1.ggIsActive=function() {
			if ((this.parentNode) && (this.parentNode.ggIsActive)) {
				return this.parentNode.ggIsActive();
			}
			return false;
		}
		me._viewdusk1.ggElementNodeId=function() {
			if ((this.parentNode) && (this.parentNode.ggElementNodeId)) {
				return this.parentNode.ggElementNodeId();
			}
			return me.player.getCurrentNode();
		}
		me._viewdusk1.ggCurrentLogicStateVisible = -1;
		this._viewdusk1.ggUpdateConditionTimer=function () {
			var newLogicStateVisible;
			if (
				(me.elementMouseOver['button_1'] == true) && 
				(me.player.getIsMobile() == false)
			...
			if (me._viewdusk1.ggCurrentLogicStateVisible != newLogicStateVisible) {
				me._viewdusk1.ggCurrentLogicStateVisible = newLogicStateVisible;
				me._viewdusk1.style[domTransition]='';
				if (me._viewdusk1.ggCurrentLogicStateVisible == 0) {
					me._viewdusk1.style.visibility=(Number(me._viewdusk1.style.opacity)>0||!me._viewdusk1.style.opacity)?'inherit':'hidden';
					me._viewdusk1.ggVisible=true;
				}
				else {
					me._viewdusk1.style.visibility=(Number(me._viewdusk1.style.opacity)>0||!me._viewdusk1.style.opacity)?'inherit':'hidden';
					me._viewdusk1.ggVisible=true;
		...
		this._viewdusk1.ggUpdatePosition=function () {
		}
		this._viewdusk2=document.createElement('div');
		this._viewdusk2__text=document.createElement('div');
		this._viewdusk2.className='ggskin ggskin_textdiv';
		this._viewdusk2.ggTextDiv=this._viewdusk2__text;
		this._viewdusk2.ggId="ViewDusk2";
		this._viewdusk2.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
		this._viewdusk2.ggVisible=true;
		this._viewdusk2.className='ggskin ggskin_text ';
		this._viewdusk2.ggType='text';
		hs ='';
		hs+='height : 56px;';
		hs+='left : 0px;';
		hs+='position : absolute;';
		...
		hs+='visibility : inherit;';
		hs+='width : 198px;';
		this._viewdusk2.setAttribute('style',hs);
		this._viewdusk2.style[domTransform + 'Origin']='50% 50%';
		hs ='position:absolute;';
		hs+='left: 0px;';
		hs+='top:  0px;';
		hs+='width: 198px;';
		...
		hs+='padding: 0px 1px 0px 1px;';
		hs+='overflow: hidden;';
		this._viewdusk2__text.setAttribute('style',hs);
		this._viewdusk2__text.innerHTML="click to see view<br\/>at dusk from the<br\/>32nd floor";
		this._viewdusk2.appendChild(this._viewdusk2__text);
		me._viewdusk2.ggIsActive=function() {
			if ((this.parentNode) && (this.parentNode.ggIsActive)) {
				return this.parentNode.ggIsActive();
			}
			return false;
		}
		me._viewdusk2.ggElementNodeId=function() {
			if ((this.parentNode) && (this.parentNode.ggElementNodeId)) {
				return this.parentNode.ggElementNodeId();
			}
			return me.player.getCurrentNode();
		}
		this._viewdusk2.ggUpdatePosition=function () {
		}
		this._viewdusk1.appendChild(this._viewdusk2);
		this._button_1.appendChild(this._viewdusk1);
		this._daytime_buttons_small.appendChild(this._button_1);
		this.divSkin.appendChild(this._daytime_buttons_small);
		...
		this._image_1.ggLeft=-115;
		this._image_1.ggTop=-76;
		...
		this._image_1.ggUpdateConditionResize=function () {
			...
			if (me._image_1.ggCurrentLogicStatePosition != newLogicStatePosition) {
				...
				me._image_1.style[domTransition]='left none, top none';
				if (me._image_1.ggCurrentLogicStatePosition == 0) {
					me._image_1.ggLeft=-115;
					me._image_1.ggTop=-66;
					me._image_1.ggUpdatePosition();
				}
				else {
					me._image_1.ggLeft=-115;
					me._image_1.ggTop=-76;
					me._image_1.ggUpdatePosition();
				}
			}
		}
		...
		me._image_2.ggCurrentLogicStatePosition = -1;
		me._image_2.ggCurrentLogicStateSize = -1;
		this._image_2.ggUpdateConditionResize=function () {
			var newLogicStatePosition;
			if (
				(me.player.getViewerSize().width <= 584)
			)
			...
			if (me._image_2.ggCurrentLogicStatePosition != newLogicStatePosition) {
				...
				me._image_2.style[domTransition]='left none, top none, width none, height none';
				if (me._image_2.ggCurrentLogicStatePosition == 0) {
					me._image_2.style.left='13px';
					me._image_2.style.top='0px';
				}
				else {
					me._image_2.style.left='23px';
					me._image_2.style.top='0px';
				}
			}
			...
			if (me._image_2.ggCurrentLogicStateSize != newLogicStateSize) {
				...
				if (me._image_2.ggCurrentLogicStateSize == 0) {
					me._image_2.style.width='128px';
					me._image_2.style.height='51px';
					me.updateSize(me._image_2);
				}
				else {
					me._image_2.style.width='184px';
					me._image_2.style.height='73px';
					me.updateSize(me._image_2);
				}
			}
		}
		this._image_2.ggUpdatePosition=function () {
			me._image_2.ggUpdateConditionResize();
		}
	...
	this.skinTimerEvent=function() {
		...
		me._tt_zoomin_1.ggUpdateConditionTimer();
		...
		me._button_simplex_auto_rotate.ggUpdateConditionTimer();
		...
		if (me.elementMouseOver['tt_start_auto_rotate']) {
		}
		...
		me._datetime.ggUpdateText();
		me._copyright.ggUpdateText();
		if (me.elementMouseOver['button_20']) {
		}
		me._viewday10.ggUpdateConditionTimer();
		if (me.elementMouseOver['button_10']) {
		}
		me._viewdusk10.ggUpdateConditionTimer();
		me._dusktime_buttons_small.ggUpdateConditionTimer();
		if (me.elementMouseOver['button_2']) {
		}
		me._viewday1.ggUpdateConditionTimer();
		me._daytime_buttons_small.ggUpdateConditionTimer();
		if (me.elementMouseOver['button_1']) {
		}
		me._viewdusk1.ggUpdateConditionTimer();
		var hs='';
		if (me._image_1.ggParameter) {
			hs+=parameterToTransform(me._image_1.ggParameter) + ' ';
		}
		hs+='rotate(' + (-1.0*(-1 * me.player.getPanNorth() + -28)) + 'deg) ';
